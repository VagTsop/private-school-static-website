...
$(document).ready(function() {
 ...
 $("form").submit(function(e){
      ...
      $(".data-table tbody").append("<tr data-stream='"+stream+"'data-title='"+title+"'data-firstName='"+firstName+"'data-lastName='"+lastName+"'><td>"+stream+"</td><td>"+title+"</td><td>"+firstName+"</td><td>"+lastName+"</td><td><button class='btn btn-info btn-xs btn-edit'>Edit</button><button class='btn btn-danger btn-xs btn-delete'>Delete</button></td></tr>");
    ...
    $("body").on("click", ".btn-update", function(){
      ...
      $(this).parents("tr").attr('data-title', stream);
      $(this).parents("tr").attr('data-stream', title);
    ...
    $(document).ready(function(){
     $('#stream, #title, #firstName, #lastName').on("cut copy paste",function(e) {
      e.preventDefault();
    });
   });
